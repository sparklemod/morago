...
public class AwsSesAdminNotificationService implements AdminNotificationService {

    private static final Logger log = LoggerFactory.getLogger(AwsSesAdminNotificationService.class);
