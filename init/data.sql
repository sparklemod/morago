...
VALUES
    (1, '+70000000002', '$2a$10$Zy/kTR7vh1rUMpb4TSJ9cOgXYnO1m6LfF9Ef7Am.O4dmB.SXTD59K', 'Elena',  'Ivanova',  'elena2@example.com', true, 1000, NULL, 'TRANSLATOR', NOW()),
    ...
    (8, '+70000000008', '$2a$10$2vOmLDdBd66ERjZWjk/8c.yg7Iu6D7ApmLvcq.gqCNqAlLRKR3ueu', 'Svetlana','Popova',  'sveta8@example.com', true, 1000, NULL, 'TRANSLATOR', NOW()),
    (9, '+70000000009', '$2a$10$FBR7m66HvL3GzRJHDAeRYuAtKeCAUzP3UNzhGa6DToEpUZ.7q7cfu', 'Alexey', 'Fedorov',  'alex9@example.com', true, 1000, NULL, 'TRANSLATOR', NOW()),
    (10,'+70000000010', '$2a$10$XDmefN6kLMKNtF7nSFBMQuLHVzj.YeF7iOh1fxG0fYCMu2pj7Y4.u','Irina',  'Alekseeva','irina10@example.com', true, 1000, NULL, 'TRANSLATOR', NOW()),
    (11,'+70000000011', '$2a$10$zQrqm1vJtu.xPYHLWKn2w.lFZz3PYcyLMKhr37t3zI.1XDNLMojUS','Oleg',   'Orlov',    'oleg11@example.com', true, 1000, NULL, 'TRANSLATOR', NOW()),
    (12,'+70000000012', '$2a$10$tctZmTIImnTUMV8OMKH8U.2rFHpT1E5Avrqt2fTFjbnk6TxXkV9ca','Maria',  'Belova',   'maria12@example.com', true, 1000, NULL, 'TRANSLATOR', NOW());
